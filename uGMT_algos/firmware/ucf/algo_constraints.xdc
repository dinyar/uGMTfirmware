...
add_cells_to_pblock [get_pblocks payload] [get_cells -quiet [list {payload/serialize/generate_serializers[5].serializer_quad}]]
add_cells_to_pblock [get_pblocks payload] [get_cells -quiet [list {payload/serialize/generate_serializers[4].serializer_quad}]]
add_cells_to_pblock [get_pblocks payload] [get_cells -quiet [list {payload/serialize/generate_serializers[3].serializer_quad}]]
add_cells_to_pblock [get_pblocks payload] [get_cells -quiet [list {payload/serialize/generate_serializers[2].serializer_quad}]]
add_cells_to_pblock [get_pblocks payload] [get_cells -quiet [list {payload/serialize/generate_serializers[1].serializer_quad}]]
add_cells_to_pblock [get_pblocks payload] [get_cells -quiet [list {payload/serialize/generate_serializers[0].serializer_quad}]]
