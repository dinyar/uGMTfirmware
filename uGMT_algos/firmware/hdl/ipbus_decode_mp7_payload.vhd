...
-- START automatically  generated VHDL the Thu Sep 17 15:25:05 2015 
    ...
    elsif std_match(addr, "----100---------------00--------") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_INPUT_DISABLE_REG, IPBUS_SEL_WIDTH)); -- input_disable_reg / base 0x08000000 / mask 0x0e000300
    elsif std_match(addr, "----100---------------01--------") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_GENERATE_LEMO_SIGNALS, IPBUS_SEL_WIDTH)); -- generate_lemo_signals / base 0x08000100 / mask 0x0e000300
    elsif std_match(addr, "----100---------------10--------") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_MUON_COUNTER_RESET, IPBUS_SEL_WIDTH)); -- muon_counter_reset / base 0x08000200 / mask 0x0e000300
-- END automatically generated VHDL
