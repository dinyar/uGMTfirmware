...
-- START automatically  generated VHDL the Tue May  5 23:34:42 2015 
    ...
    elsif std_match(addr, "----------------100------0000000") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_BC0_ERRORS_0, IPBUS_SEL_WIDTH)); -- bc0_errors_0 / base 0x00008000 / mask 0x0000e07f
    elsif std_match(addr, "----------------100------0000001") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_BC0_ERRORS_1, IPBUS_SEL_WIDTH)); -- bc0_errors_1 / base 0x00008001 / mask 0x0000e07f
    elsif std_match(addr, "----------------100------0000010") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_BC0_ERRORS_2, IPBUS_SEL_WIDTH)); -- bc0_errors_2 / base 0x00008002 / mask 0x0000e07f
    elsif std_match(addr, "----------------100------0000100") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_BC0_ERRORS_3, IPBUS_SEL_WIDTH)); -- bc0_errors_3 / base 0x00008004 / mask 0x0000e07f
    elsif std_match(addr, "----------------100------0001000") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_BNCH_CNT_ERRORS_0, IPBUS_SEL_WIDTH)); -- bnch_cnt_errors_0 / base 0x00008008 / mask 0x0000e07f
    elsif std_match(addr, "----------------100------0010000") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_BNCH_CNT_ERRORS_1, IPBUS_SEL_WIDTH)); -- bnch_cnt_errors_1 / base 0x00008010 / mask 0x0000e07f
    elsif std_match(addr, "----------------100------0100000") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_BNCH_CNT_ERRORS_2, IPBUS_SEL_WIDTH)); -- bnch_cnt_errors_2 / base 0x00008020 / mask 0x0000e07f
    elsif std_match(addr, "----------------100------1000000") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_BNCH_CNT_ERRORS_3, IPBUS_SEL_WIDTH)); -- bnch_cnt_errors_3 / base 0x00008040 / mask 0x0000e07f
-- END automatically generated VHDL
